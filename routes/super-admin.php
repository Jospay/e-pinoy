...
Route::middleware(['auth', 'verified', 'user_type:super_admin'])->prefix('super-admin')->name('super-admin.')->group(function () {
    ...
    Route::get('boundary-contract/vehicle-types', [BoundaryContractController::class, 'getVehicleTypes'])->name('super-admin.boundaryContract.vehicleTypes');
    Route::get('boundary-contract/drivers', [BoundaryContractController::class, 'getDrivers'])->name('super-admin.boundaryContract.drivers');
