...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('routes', function (Blueprint $table) {
            ...
            $table->foreignId('reservation_id')->nullable()->constrained('reservations')->onDelete('restrict');
            $table->foreignId('taxi_reservation_id')->nullable()->constrained('taxi_reservations')->onDelete('restrict');
