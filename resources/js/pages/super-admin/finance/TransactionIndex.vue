...
<template>
  ...
  <h2 class="whitespace-nowrap font-mono text-xl font-semibold">
  ...
  <div class="flex w-full flex-col gap-3 sm:flex-row sm:flex-wrap lg:w-auto lg:justify-end">
    ...
    <div class="flex w-full gap-3 sm:w-auto">
      ...
      <Select v-model="selectedCategory">
        ...
        <SelectContent>
          <SelectItem value="revenue" class="cursor-pointer">Revenue</SelectItem>
          <SelectItem value="expense" class="cursor-pointer">Expense</SelectItem>
        </SelectContent>
      </Select>
    </div>
